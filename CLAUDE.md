...
- [ ] **s192 — QA tay Bé Gấu upload ảnh/file trên staging**: gửi thử 1 ảnh (vd chụp màn hình lỗi/bảng giá
  NCC), 1 PDF, 1 file Excel/CSV — xác nhận Bé Gấu đọc đúng nội dung và trả lời hợp lý; xác nhận tin nhắn
  thường (không đính kèm) vẫn chạy bình thường như trước (route đổi sang nhận thêm `multipart/form-data`
  song song JSON cũ). Nếu OK, cân nhắc làm tiếp gap "xuất file" (Excel/Word/PDF) cho Bé Gấu — xem báo cáo
  đối chiếu Bé Gấu vs Gấu Pro (artifact đã gửi Hiếu, không lưu trong repo).
