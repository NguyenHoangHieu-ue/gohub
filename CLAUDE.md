...
- [ ] **Chọn lô UI tiếp theo** — Lô 2 chính thức (B2B: KPI→StatTile, bảng Tier/Strategic→DataTable; B2C
  cần audit thêm 2 component con trước) hoặc lô sửa-hex-sai riêng (7 file còn `#003B95`/`#002B70`/`#002d73`:
  cs-troubleshoot, orders, staff, to-gau, users, settings, `analytics/page.tsx` — an toàn nhất, chỉ đổi màu).
