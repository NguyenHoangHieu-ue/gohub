...
- [ ] **s193 — QA thị giác 5 trang vừa đổi UI trên staging**: All-Time, Scheduled, Schema, Promotions,
  Countries — xem số liệu/hành vi khớp bản cũ (chưa tự QA qua Chrome lần này). Sau đó chọn lô UI tiếp theo
  (Lô 2: B2B, hoặc lô sửa-hex-sai riêng 7 file `#003B95` còn sót).
