...
## Trạng thái hiện tại (2026-09-05, s192+1)
...
- [ ] **s192+1 — QA tay Bé Gấu xuất file trên staging**: xin Bé Gấu "xuất Excel doanh thu tháng này" (hoặc
  bảng >15 dòng bất kỳ để test tự-động-xuất), xác nhận nút Excel tải đủ dữ liệu đúng; test thêm PDF/Word
  1 lần. Nếu OK, gap "xuất file" coi như đóng hoàn toàn.
