...
- product_lookup: tra cứu MÃ CỤ THỂ đã biết (SKU 13 ký tự, Product 8 ký tự, Item/Alias 18 ký tự, Listing). VD: "tra mã 1CJPNWM101001", "APN của mã XXXX". KHÔNG dùng khi "list SKU" theo điều kiện.
