...
const RE = {
  ...
  usage:     /luong su dung|luong dung|muc (su )?dung|su dung data|data usage|3hk data usage|tieu thu data|data tieu thu|tieu thu (data|gb)|tong luong data|luong data (tieu thu|su dung)|usage.*3hk|3hk.*usage|thong ke.*data_usage_log|query.*data_usage/,
