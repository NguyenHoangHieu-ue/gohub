...
export const SUPABASE_TABLES: Record<string, string> = {
  ...
  skus:                   "SKU (sku_code 13 ký tự, sku_ref, product_code, tenant, status, sim_esim, product_type, currency, day_amount, day_amount_unit, data_amount, data_amount_unit, parents, frame, datapack, throttle_speed, data, speed, call, call_sms_details, vendor_expirations, vendor_sku, vendor_sku_sim, latest_cogs, latest_cogs_currency, data_plan, topup_timing, date_created, last_modified_date, synced_at) — KHÔNG có hotspot/kyc_needed/network_type/operator_code (nằm ở bảng products, JOIN theo product_code)",
