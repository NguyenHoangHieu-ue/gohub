...
import { getAnalyticsSource, getDateFilter, getStrategicPartnersList, cachedQuery, CACHE_HEADERS, analyticsGuard } from "@/lib/analytics-helpers"
...
export async function GET(req: NextRequest) {
  ...
  const cacheKey    = `revenue-chart:${startDate}:${endDate}:${dateColumn}:${companyCode}`
