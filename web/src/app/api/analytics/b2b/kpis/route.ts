...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json([
      ...
      { label: "GPM2 %",         value: cRev > 0 ? (cGpm2/cRev)*100 : 0, lastPeriod: pRev > 0 ? (pGpm2/pRev)*100 : 0, change: (cRev > 0 ? (cGpm2/cRev)*100 : 0) - (pRev > 0 ? (pGpm2/pRev)*100 : 0), isPositive: true, isCurrency: false },
